...
const OwnerOperator = () => {
  ...
  const tableConfig = {
    ...
    columns: [
      ...
      {
        id: "weight",
        label: "Weight(kg/pound)",
        renderer: ({ row }) => {
          return (
            <Fragment>
              {row.weight.kilograms}/{row.weight.pounds}
            </Fragment>
          );
        },
      },
      {
        ...
        renderer: ({ row }) => {
          return <Fragment>{row.contact.emailAddress}</Fragment>;
        },
      },
      {
        id: "contactPersonName",
        ...
        renderer: ({ row }) => {
          return <Fragment>{row.contact.name}</Fragment>;
        },
      },
      {
        ...
        renderer: ({ row }) => {
          return <Fragment>{row.contact.phoneNumber}</Fragment>;
        },
      },
